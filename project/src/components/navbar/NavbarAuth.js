...
import { LogoImage } from "assets/img/logo/logologo.png";
...
export default function AuthNavbar(props) {
  ...
  let brand = (
    <Link
      ...
      alignItems='center'
      color={mainText}>
      <Stack direction='row' spacing='12px' align='center' justify='center' marginLeft='35px'>
        <LogoImage h='26px' w='175px' />
      </Stack>
  ...
  if (props.secondary === true) {
    brand = (
      <Link
        ...
        alignItems='center'
        color={mainText}>
        <LogoImage h='26px' w='175px' marginLeft='35px' />
      </Link>
    );
